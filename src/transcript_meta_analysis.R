...
transcript_meta_analysis<-function(study_path_vector=study_path_vector, grouping_path_vector=grouping_path_vector,test=c("Burden", "SKAT","SKATO","SMMAT"), min_study_cmac=1,min_meta_cmac=20,rho=c(0, 0.1^2, 0.2^2, 0.3^2, 0.4^2, 0.5^2, 0.5, 1),use.anytranscript=T,combine.pval=T){
