...
## perfrom analysis
kernell_variance_component_ukbb(gdsfile=gdsfile,groupfile=groupfile,phenfile=phenfile,ID_col=ID_col,nullfile=nullfile,outfile=outfile, test="ExtractKernelStatistics", vc.test="Score.SPA", AF.max=0.01, MAC.max=Inf,use.weights=FALSE)
